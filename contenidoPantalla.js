class Contenido {
  ...
  cargarImagenes() {
    ...
    this.marco = loadImage("data/marco.jpg");
  }
  ...
  contenidoPantalla3() {
    ...
    background(58);
    image(this.marco,550,0,700,700)
    //background(100);
    
    image(this.imagenes[1], 600, 70, 600, 600);
    fill(0)
    rect(550,700,700,600)
    
    fill(255);
    
    //text(this.textos[0],100,100);
    text("Continuar", 1360, 580);
    text("Eres miembro de AES, vuelves de una misión en el Extremo\n Oriente y recibes una llamada urgente de tu jefe, T.\n Te diriges a Washington en tu avioneta. Al llegar, te recoge\n una limusina y T te informa de un asunto que no puede\n esperar, interrumpiendo tus vacaciones merecidas.", 570, 740);
  }
  contenidoPantalla4() {
    background(58);
    image(this.marco,550,0,700,700)
    ...
    image(this.imagenes[2], 600, 70, 600, 600);
    fill(0)
    rect(550,700,700,600)
  ...
  contenidoPantalla5() {
    ...
    image(this.imagenes[3], 600, 70, 600, 600);
    fill(0)
    rect(550,700,700,600)
  ...
  contenidoPantalla6() {
    ...
    image(this.imagenes[4], 600, 70, 600, 600);
    fill(0)
    rect(550,700,700,600)
  ...
  contenidoPantalla7() {
    ...
    image(this.imagenes[5], 600, 70, 600, 600);
    fill(0)
    rect(550,700,700,600)
  ...
  contenidoPantalla8() {
    ...
    image(this.imagenes[6], 600, 70, 600, 600);
    fill(0)
    rect(550,700,700,600)
  ...
  contenidoPantalla9() {
    ...
    image(this.imagenes[7], 600, 70, 600, 600);
    fill(0)
    rect(550,700,700,600)
    
    fill(255);
    text("Continuar", 1360, 580);
    text ("A bordo del avión, identificas a los dos hombres sospechosos en los asientos centrales.\n Te sientas en la parte trasera junto a Juan Morales, un adolescente. Después de\n una hora, los hombres sacan revólveres y toman el control de\n la cabina. Uno de ellos te apunta con su arma y te ordena no hacer movimientos\n bruscos. Tu portafolios está cerca, pero cualquier movimiento podría desencadenar\n una reacción violenta. Debes decidir si intentar contraatacar o seguir las órdenes de \nlos secuestradores.",570, 740);
  }
  contenidoPantalla10() {
  ...
  contenidoPantalla20() {
    ...
    image(this.imagenes[18], 600, 70, 600, 600);
    fill(0)
    rect(550,700,700,600)
